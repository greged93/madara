...
use crate::tests::utils::get_contract_class_cairo_0;
...
pub fn get_invoke_dummy() -> Transaction {
    ...
    let sender_address = Felt252Wrapper::from_hex_be(super::constants::BLOCKIFIER_ACCOUNT_ADDRESS_CAIRO_0).unwrap();
...
fn get_storage_read_write_dummy() -> Transaction {
    ...
    let raw_contract_class = get_contract_class_cairo_0("NoValidateAccount.json");
